...
"""
        ...
        def first_str_4(call): # Дополнительное образование
            ...
            button_1 = telebot.types.InlineKeyboardButton('🔙 Назад 🔙', callback_data="Sotr_page1") # кнопка 1
            button_2 = telebot.types.InlineKeyboardButton('Перейти на сайт', url='https://opencollege-nsk.ru/education/') # кнопка 2
            back = telebot.types.InlineKeyboardButton(text='📱 В меню 📱', callback_data='mainmenu') # кнопка назад
...
специалист учебного офиса - 
Елена Андреевна Козлова
...
"""
        ...
        if call.data in sotr_dict:
            ...
            bot.send_message(-1001822755040, '{} \n<{}> <{}> <{}> <{}>\n\n Зашел в раздел <{}> меню Сотрудника/Преподавателя'.format(current_time(), call.from_user.id, call.from_user.first_name, call.from_user.last_name,call.from_user.username, call.data))
