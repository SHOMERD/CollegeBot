...
#⃣ Дополнительно (обязательно принести к 01.09 для обучения на очной и очно-заочной форме):

1️⃣  - медицинская справка, форма 086-У для всех специальностей очной и очно-заочной формы (оригинал)

2️⃣ - страховой медицинский полис (копия)

*⃣ - приписное/военный билет (для юношей);

*⃣ - документы о смене фамилии/имени/отчества (при необходимости).
...
"""
        ...
        dict_1 = {'about':first_str_1,
                  'specials':first_str_2,
                  'docum':first_str_3,
                  'kak_postup':first_str_4,
                  'cost':first_str_5,
                  'exams':first_str_6,
                  'dop_degree':first_str_7,
                  'clubs_abitur':first_str_8,
                  'license1':first_str_9,
                  'partnership':first_str_10,
                  'affisha':first_str_11,
                  'kuratori':first_str_12,
                  'way':first_str_13,
                  'transac':first_str_14,
                  'links1':first_str_15,
                  'spec1':first_str_2_1,
                  'spec2':first_str_2_2,
                  'spec3':first_str_2_3,
                  ...
                  'spec8':first_str_2_8,
                  'spec9':first_str_2_9,
                  'spec10':first_str_2_10,
                  'spec11':first_str_2_11,
                  'spec12':first_str_2_12,
                  'spec13':first_str_2_13,
                  }  
